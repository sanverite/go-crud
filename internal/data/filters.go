...
// The calculateMetadata() function calculates the appropriate metadata
// values given the total number of records, current page, and page size
// values.
...
// our safelist and if it does, extract the column name from the Sort field
