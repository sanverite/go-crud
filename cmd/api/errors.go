...
func (app *application) errorResponse(w http.ResponseWriter, r *http.Request, status int, message interface{}) {
	...
	// an error then log it, and fall back to sending the client an empty response
...
// an unexpected problem at runtime. It logs the detailed error message, then use
// the errorResponse() helper to send a 500 Internal Server Error status code and
...
// The badRequestResponse() method will be used to send a 400 Bad Request status
